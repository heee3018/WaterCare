        ...
        for key in list(self.data.keys()):
            ...
            if self.ser.read(1) == b'\xE5':
                ...
                while repeat > 0:
                    ...
                    try:
                        time              = current_time()
                        return_serial_num = get_return_serial_num(read_format(read_data, 7, 11))
                    ...
                    if USE_DB:
                        db.send(f"INSERT INTO {TABLE} (time, serial_num, flow_rate, total_volume) VALUES ('{time}', '{serial_num}', '{flow_rate}', '{total_volume}')")
